    ...
    <section id="contact" className="mx-auto">
        <div className="mx-auto px-4 sm:px-6 lg:px-8">
            <div className="m-3 lg:mb-0 mb-10">
                <div className="">
                    <div className="relative">
                        <img src="https://pagedone.io/asset/uploads/1696488602.png" alt="ContactUs tailwind section" className="w-full h-full lg:rounded-l-xl rounded-xl bg-blend-multiply bg-indigo-700 object-cover"/>
                        ...
                        <div className="absolute bottom-0 w-full lg:p-11 p-5">
                            <div className="bg-white rounded-lg p-6 block">
                                <a href="javascript:;" className="flex items-center mb-6">
                                    ...
                                    <h5 className="text-black text-sm text-base font-normal leading-6 ml-5">+63 917-700-0790 / +63 917-135-2866 / +83 878-8836</h5>
                                </a>
                                <a href="javascript:;" className="flex items-center">
                                    ...
                                    <h5 className="text-black text-sm text-base font-normal leading-6 ml-5">17-A Acharon Bldg., Quezon Avenue, Dadiangas West, General Santos City</h5>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div className="m-3 bg-gray-50 p-5 lg:p-11 lg:rounded-r-2xl rounded-2xl">
                <h2 className="text-indigo-600 font-manrope text-2xl font-semibold leading-10 mb-11">Send Us A Message</h2>
